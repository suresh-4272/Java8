...
public class maxminExample {
	...
	static List<Person> filterMultiPersons(){
	...
	public static void main(String[] args) {
      ...
      System.out.println("TallestPerson : "+getTallestPerson().get());
      System.out.println("ShortestPerson : "+getShortestPerson().get());
      System.out.println("Tallest Group : "+filterMultiPersons());
